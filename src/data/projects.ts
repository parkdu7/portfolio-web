...
신한은행 해커톤(2주)에서 팀 5명 중 Android 및 백엔드를 담당하여 대상을 수상했습니다.`,
        images: [
            "/images/projects/camping/campung_1.jpg",
            "/images/projects/camping/campung_2.jpg",
            "/images/projects/camping/campung_3.jpg",
            "/images/projects/camping/campung_4.png",
        ],
        techTags: [
            "Android",
            "Kotlin",
...
실제 교육생 400명이 사용하는 서비스로 운영되었습니다.`,
        images: [
            "/images/projects/ssafy-market/ssafymarket_1.png",
            "/images/projects/ssafy-market/ssafymarket_2.png",
            "/images/projects/ssafy-market/ssafymarket_3.png",
            "/images/projects/ssafy-market/ssafymarket_4.png",
        ],
        techTags: [
            "React",
            "TypeScript",
    ...
    },
    {
        ...
        shortDesc:
            "논문 검색/추천 빅데이터 플랫폼 — SSAFY 특화 프로젝트 우수상 1위",
...
PySpark로 논문 간 유사도를 사전 계산하여 마인드맵 형태의 실시간 연관 논문 탐색 기능을 제공합니다.`,
        images: [
            "/images/projects/rsp/rsp_1.png",
            "/images/projects/rsp/rsp_2.png",
            "/images/projects/rsp/rsp_3.png",
            "/images/projects/rsp/rsp_4.png",
            "/images/projects/rsp/rsp_5.png",
            "/images/projects/rsp/rsp_6.png",
        ],
        techTags: [
            "OpenSearch",
            "PySpark",
    ...
    },
    {
        ...
        title: "ARFNI",
        shortDesc:
            "GUI 기반 인프라 배포 자동화 플랫폼 — SSAFY 자율 프로젝트 우수상 2위",
...
Redux Toolkit으로 Canvas 상태를 관리하고, Debounce(2초) 자동 저장으로 Race Condition을 방지했습니다. Tauri IPC 기반 실시간 배포 로그를 구독하고, Go 엔진에서 AtomicBool로 중복 배포를 방지하며 멀티스레드 stdout/stderr 스트리밍을 구현했습니다.`,
        images: [
            "/images/projects/arfni/arfni_1.gif",
            "/images/projects/arfni/arfni_2.gif",
            "/images/projects/arfni/arfni_3.png",
            "/images/projects/arfni/arfni_4.gif",
            "/images/projects/arfni/arfni_5.gif",
            "/images/projects/arfni/arfni_6.jpg",
        ],
        techTags: [
            "React 19",
            "Redux Toolkit",
...
FCM 푸시 알림으로 데일리 퀴즈와 거래 알림을 제공하며, 메인/학습/포트폴리오/랭킹 화면 Android UI를 개발했습니다.`,
        images: [
            "/images/projects/ragohaltae/lago_1.jpg",
            "/images/projects/ragohaltae/lago_2.jpg",
            "/images/projects/ragohaltae/lago_3.jpg",
            "/images/projects/ragohaltae/lago_4.jpg",
            "/images/projects/ragohaltae/lago_5.png",
            "/images/projects/ragohaltae/lago_6.png",
            "/images/projects/ragohaltae/lago_7.jpg",
            "/images/projects/ragohaltae/lago_8.jpg",
            "/images/projects/ragohaltae/lago_9.png",
        ],
        techTags: [
            "Android",
            "Kotlin",
    ...
    },
    {
        ...
        title: "로웨인 스마트팜 대시보드",
        shortDesc:
            "Flutter 기반 IoT 스마트팜 모니터링 대시보드 — 인턴십 프로젝트",
...
백엔드는 Node-Red 기반 서버를 FastAPI + MQTT(paho-mqtt)로 리팩토링하고, MongoDB Projection으로 데이터 전송량 60%를 절감했습니다.`,
        images: [
            "/images/projects/lowain/rowain_1.png",
            "/images/projects/lowain/rowain_2.png",
        ],
        techTags: [
            "Flutter",
            "Dart",
...
Sequelize ORM으로 9개 모델의 데이터베이스를 설계하고, useEffect 클린업으로 소켓을 안전하게 해제합니다.`,
        images: [
            "/images/projects/mongdangbul/mongdangbul_1.png",
            "/images/projects/mongdangbul/mongdangbul_2.png",
            "/images/projects/mongdangbul/mongdangbul_3.png",
            "/images/projects/mongdangbul/mongdangbul_4.png",
        ],
        techTags: [
            "React",
            "Node.js",
...
React Router Location State로 페이지 간 하드웨어 데이터를 전달하고, 30회 이상의 커밋으로 CORS 이슈를 해결했습니다.`,
        images: [
            "/images/projects/myspec/myspec_1.png",
            "/images/projects/myspec/myspec_2.png",
        ],
        techTags: [
            "React",
            "TypeScript",
...
TypeScript 인터페이스와 제네릭 타입으로 재사용 가능한 컴포넌트를 설계하고, React Router 동적 라우팅과 state를 활용했습니다.`,
        images: [
            "/images/projects/sequence/sequence_1.png",
            "/images/projects/sequence/sequence_2.png",
        ],
        techTags: [
            "React",
            "TypeScript",
